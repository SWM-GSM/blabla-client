...
class _CrewDetailViewState extends State<CrewDetailView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        qaColumn(
                            "어떤 크루원들과 함께하고 싶나요?", viewModel.crew!.preferMember),
                        qaColumn(
                            "얼마나 자주 모이고 싶나요?", viewModel.crew!.meetingCycle),
        ...
        bottomSheet: viewModel.crew == null
            ? null
            : Container(
                    ...
                    if (viewModel.crew!.status == "NOTHING")
                      GestureDetector(
                        onTap: () async {
                          if (viewModel.crew!.autoApproval) {
                            await viewModel
                                .joinCrew(viewModel.crew!.autoApproval);
                          } else {
                            // 수정 - 모달창으로 수정
                            await viewModel.joinCrew(
                      ...
                      Container(
                        ...
                        child: Text(
                          "가입 완료",
                          style:
                              BlaTxt.txt16B.copyWith(color: BlaColor.grey800),
                        ),
                      )
