...
class CrewsMainView extends StatelessWidget {
  const CrewsMainView(
      {super.key, required this.crewId, required this.crewName});
  final int crewId;
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                final token = await viewModel.getAgoraToken(
                                    viewModel.voiceRoomUsers.isNotEmpty);
                                print(token);
                                final permission =
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            "더보기",
                                            style: BlaTxt.txt14ML.copyWith(
                                                color: BlaColor.grey600),
                                          ),
                                          SvgPicture.asset(
                                              "assets/icons/ic_16_arrow_right.svg",
                                              width: 16,
