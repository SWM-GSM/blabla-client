          ...
          children: [
           const SizedBox(height: 12),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("%", style: BlaTxt.txt14R.copyWith(color: BlaColor.orange)),
                  ],
                )
              ],
            ),
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    height: 4,
                    width: (MediaQuery.of(context).size.width - 40) * (80 / 100),
                    margin: const EdgeInsets.only(top: 12, bottom: 20),
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(2),
            ...
            GridView.count(
                ...
                children: List.generate(3, (idx) => MysContentTileWidget())),
          ],
        ));
  }
}
